...
public class Basics : MonoBehaviour
{
	...
	IEnumerator Start()
	{
        ...
        // Давайте переместим фиолетовый куб на 6,0,0 см за 2 секунды
        // а также изменим его цвет на желтый.
        // Чтобы изменить его цвет, нам придется использовать его материал в качестве мишени (вместо его преобразования).

        purpleCube.DOMove(new Vector3(6,0,0), 2).SetRelative();
        // Also, let's set the color tween to loop infinitely forward and backwards
        // Кроме того, давайте настроим цветовую анимацию так, чтобы она бесконечно повторялась вперед и назад
