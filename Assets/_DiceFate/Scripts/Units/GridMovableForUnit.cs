...
{
    public class GridMovableForUnit : MonoBehaviour
    {
        ...
        public int intermediateNodes = 0; // Количество промежуточных узлов между основными точками - отнимаемузлы + добовляем узлы
