...
public class DF_MiniFigureController : MonoBehaviour
{
    ...
    // Обработчик изменения состояния выделения
    void OnSelectionChanged(bool isSelected)
    {
        // Можно добавить дополнительную логику при выделении/снятии выделения
        Debug.Log("Состояние выделения изменено: " + isSelected);
    }
